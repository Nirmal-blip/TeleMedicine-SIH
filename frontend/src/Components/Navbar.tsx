        ...
        <nav className="w-full fixed z-10 bg-[#064848] py-3 px-8 poppins">
            <div className="w-full flex justify-between items-center">
                ...
                <ul className="flex space-x-3">
                    <li
                        className="text-white flex gap-2 items-center hover:text-[#81dede] cursor-pointer text-xl px-4 py-2 rounded-full hover:bg-[#0d3733] hover:scale-105 transform duration-300 ease-in-out"> 
                        <FontAwesomeIcon icon={faHome} className='fa-solid fa-beat text-white text-xl ' />Home
                    </li>
                    <li
                        className="text-white flex gap-2 items-center hover:text-[#81dede] cursor-pointer text-xl px-4 py-2 rounded-full hover:bg-[#0d3733] hover:scale-105 transform duration-300 ease-in-out">
                        <FontAwesomeIcon icon={faCalendarCheck} className='fa-solid fa-beat text-white text-xl ' />Book Appointment
                    </li>
                    <li
                        className="text-white flex gap-2 items-center hover:text-[#81dede] cursor-pointer text-xl px-4 py-2 rounded-full hover:bg-[#0d3733] hover:scale-105 transform duration-300 ease-in-out">
                        <FontAwesomeIcon icon={faVideo} className='fa-solid fa-beat text-white text-xl ' />Video Consultation
                    </li>
                    <button
                    ...
                    >
                        <FontAwesomeIcon icon={faUserPlus} className='fa-solid fa-beat text-lg ' />SignUp
                    </button>
                </ul>
            </div>
