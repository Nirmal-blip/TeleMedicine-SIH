...
const MedicineShop: React.FC = () => {
  ...
  const fetchMedicines = async () => {
    try {
      ...
      const response = await fetch(`${(import.meta as any).env.VITE_BACKEND_URL}/api/medicines?${params}`);
      const data = await response.json();
  ...
  const fetchCategories = async () => {
    try {
      const response = await fetch(`${(import.meta as any).env.VITE_BACKEND_URL}/api/medicines/categories`);
      const data = await response.json();
      setCategories(data);
    } catch (error) {
  ...
  const addToCart = async (medicine: Medicine) => {
    try {
      const response = await fetch(`${(import.meta as any).env.VITE_BACKEND_URL}/api/cart/add`, {
        method: 'POST',
        headers: {
