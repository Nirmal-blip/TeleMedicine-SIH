...
const DoctorDashboard: React.FC = () => {
  ...
  const fetchDashboardStats = async () => {
    try {
      ...
      const appointmentsResponse = await axios.get(`${BACKEND_BASE_URL}/api/appointments/my/upcoming`, {
        withCredentials: true,
      });
      ...
      const patientsResponse = await axios.get(`${BACKEND_BASE_URL}/api/patients`, {
        withCredentials: true,
      });
      
      // Get doctor's own stats
      const doctorStatsResponse = await axios.get(`${BACKEND_BASE_URL}/api/doctors/me/stats`, {
        withCredentials: true,
      });
  ...
  const handleNameClick = async () => {
    ...
    if (newName && newName.trim()) {
      try {
        ...
        await axios.patch(`${BACKEND_BASE_URL}/api/doctors/me`, {
