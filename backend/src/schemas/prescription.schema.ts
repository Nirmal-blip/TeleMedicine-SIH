...
export class Prescription {
  ...
  @Prop({ required: true })
  doctorId: string; // Custom doctor ID like DOC2024000001 for easy querying
...
// Note: patientId and doctorId indexes may be automatically created by @Prop({ required: true })
